...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, quantity, image, added_by) VALUES('$name', '$price', '$quantity', '$image', '$added_by')") or die('query failed');
...
<section class="add-products">
   ...
   <h1 class="title">Hello <?php echo $_SESSION['user_name'] ?> </h1>
   <h1 class="title">Want to sell?</h1>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <?php
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE added_by = '$added_by'") or die('query failed');
      ...
      <div class="box">
         ...
         <div class="name">Available:<?php echo $fetch_products['quantity']; ?></div>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="number" min="0" name="update_quantity" value = "<?php echo $fetch_update['quantity']; ?>" class="box">
